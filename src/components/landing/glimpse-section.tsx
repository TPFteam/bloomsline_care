...
import { Sun, Coffee, Heart, Moon, Scale, TrendingUp, MessageCircle, Check, Plus, Share2, FolderOpen, BarChart3, FileText, ClipboardList, Dumbbell, User, Calendar, Tag, X } from 'lucide-react'
