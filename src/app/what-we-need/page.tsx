    ...
    sections: {
      ...
      cofounderTransparency: {
        ...
        greens: {
          ...
          items: [
            { point: 'The product is alive', detail: 'Not a Figma file. Not a pitch deck. A real platform, live, with real practitioners clicking real buttons. Built in months by two people who probably need more sleep.' },
            { point: 'The pain is personal', detail: 'We didn\'t find this market in a McKinsey report. We found it in therapy waiting rooms and broken Google Drive folders. Aditya built Doctalink before this. We both lived the patient side. This product was born from scars, not spreadsheets.' },
            { point: 'The AI actually does something', detail: 'Bloom writes pre-session briefs, surfaces buried notes, tracks patterns. Not "AI-powered" in a marketing way — in a "your 5pm client mentioned something 3 months ago and Bloom remembers" way.' },
            { point: 'Our burn rate is basically a Netflix subscription', detail: 'Two founders, no office, no salaries to pay. We run on API costs and stubbornness. We\'re not dying next month — which at this stage is basically a superpower.' },
            { point: 'Therapists get it immediately', detail: 'Yoann said "I could figure this out without you explaining." That almost never happens with clinical tools. Most competitors look like they were designed by someone who hates joy.' },
            { point: 'The full loop is built', detail: 'Practitioner creates, shares, member engages, practitioner sees it. Web + mobile + AI. The boring, hard, unglamorous infrastructure work? Done. Nobody else connects both sides like this.' },
          ],
        },
        greys: {
          title: 'What We Don\'t Know Yet',
          items: [
            { point: 'We\'re not industry experts', detail: 'Zero clinical background. Zero psychology degrees. We learned this market by building, demoing, and occasionally embarrassing ourselves. We have blind spots — and we know it.' },
            { point: 'No product-market fit yet', detail: 'Sandra loved notes search. Kevin loved resource sharing. Yoann loved the UX. Everyone loves something different. We\'re still looking for the ONE thing that makes someone ditch their Google Drive folder.' },
            { point: 'Onboarding is hand-holdy', detail: 'Every practitioner gets personal calls, custom setup, 3-4 weeks of white-glove treatment. Beautiful — but it doesn\'t scale. Can therapists self-serve? Honestly, we have no idea.' },
            { point: 'Privacy might be a wall, not a speed bump', detail: 'Patricia refused to put any patient data online. Others hesitated. Is that 10% of the market or 50%? If it\'s 50%, our entire strategy needs a rewrite.' },
            { point: 'We\'re learning how they buy', detail: 'Solo practitioners, cabinet owners, French vs. international — they all decide differently. We don\'t have a playbook yet. We\'re writing it in real time.' },
          ],
        },
        reds: {
          title: 'The Real Risks',
          items: [
            { point: 'Revenue: zero. Literally zero.', detail: 'Lots of "interesting!" and "I\'d try it!" — zero euros in the bank from customers. If that doesn\'t change in 90 days, something fundamental is wrong.' },
            { point: 'No clinician in the room', detail: 'We\'re making product decisions about clinical workflows without a clinical person on the team. We validate through demos, but we could be building the wrong things and not even know it.' },
            { point: 'Regulation is a maze we\'re still mapping', detail: 'GDPR, HDS, patient data laws — we\'re learning as we go. One compliance mistake at this stage could be existential. Not "oops" existential. Actually existential.' },
            { point: 'A data leak or legal issue hits everyone', detail: 'We handle sensitive health data. If something goes wrong — a breach, a complaint, a regulatory action — it doesn\'t just affect the company. Every person on the team is directly or indirectly impacted. This is the weight of building in healthtech.' },
            { point: 'Funded competitors exist', detail: 'Doctolib, Quenza, SimplePractice — they have money, teams, users. We\'re ahead on AI + UX today. That window won\'t stay open forever.' },
            { point: 'Therapists might not want this yet', detail: 'Many are genuinely happy with paper notebooks and Google Drive. Selling to people who don\'t think they have a problem is a special kind of hard. We might be too early.' },
          ],
        },
        whyJoin: {
          title: 'Why Join Now — Despite All of This',
          items: [
            'You\'re joining a working product, not a pitch deck. The foundation is built — what\'s missing is the team to turn it into a business.',
            'You join before revenue = founding-level equity, founding-level influence, and zero "that\'s how we\'ve always done it" to fight against.',
            'Mental health tooling is broken and everyone knows it. The tailwinds are structural, not hype.',
            'This page exists because we\'d rather scare you with honesty than impress you with spin. If something here worries you, good. If something excites you despite all of it — that\'s the signal.',
            'The hardest part is done. Next up: market fit, revenue, growth. Your impact shows up in months, not years.',
          ],
        },
      },
    },
    ...
    sections: {
      ...
      cofounderTransparency: {
        ...
        greens: {
          ...
          items: [
            { point: 'Le produit est vivant', detail: 'Pas un fichier Figma. Pas un pitch deck. Une vraie plateforme, live, avec de vrais praticiens qui cliquent sur de vrais boutons. Construit en quelques mois par deux personnes qui devraient probablement dormir plus.' },
            { point: 'La douleur est personnelle', detail: 'On n\'a pas trouvé ce marché dans un rapport McKinsey. On l\'a trouvé dans des salles d\'attente de psy et des dossiers Google Drive en vrac. Aditya a construit Doctalink avant. On a tous les deux vécu le côté patient. Ce produit est né de cicatrices, pas de tableurs.' },
            { point: 'L\'IA fait vraiment quelque chose', detail: 'Bloom écrit des briefs pré-séance, fait remonter des notes oubliées, suit les patterns. Pas "propulsé par l\'IA" façon marketing — façon "votre client de 17h a mentionné un truc il y a 3 mois et Bloom s\'en souvient".' },
            { point: 'Notre burn rate c\'est un abonnement Netflix', detail: 'Deux fondateurs, pas de bureau, pas de salaires à payer. On tourne aux coûts API et à l\'entêtement. On ne meurt pas le mois prochain — ce qui à ce stade est un superpouvoir.' },
            { point: 'Les thérapeutes comprennent immédiatement', detail: 'Yoann a dit "je pourrais m\'en sortir sans qu\'on m\'explique." Ça n\'arrive quasi jamais avec les outils cliniques. La plupart des concurrents ont l\'air d\'avoir été designés par quelqu\'un qui déteste la joie.' },
            { point: 'La boucle complète est construite', detail: 'Le praticien crée, partage, le membre s\'engage, le praticien le voit. Web + mobile + IA. Le travail d\'infrastructure ennuyeux et ingrat ? Fait. Personne d\'autre ne connecte les deux côtés comme ça.' },
          ],
        },
        greys: {
          title: 'Ce Qu\'on Ne Sait Pas Encore',
          items: [
            { point: 'On n\'est pas des experts de l\'industrie', detail: 'Zéro background clinique. Zéro diplôme en psy. On a appris ce marché en construisant, en faisant des démos, et en se ridiculisant parfois. On a des angles morts — et on le sait.' },
            { point: 'Pas de product-market fit encore', detail: 'Sandra a adoré la recherche de notes. Kevin le partage de ressources. Yoann l\'UX. Tout le monde aime un truc différent. On cherche encore LA chose qui fait lâcher le dossier Google Drive.' },
            { point: 'L\'onboarding est très accompagné', detail: 'Chaque praticien reçoit des appels perso, un setup sur-mesure, 3-4 semaines de traitement VIP. Magnifique — mais ça ne scale pas. Est-ce que les thérapeutes peuvent se débrouiller seuls ? Honnêtement, aucune idée.' },
            { point: 'La vie privée : mur ou ralentisseur ?', detail: 'Patricia a refusé de mettre des données patient en ligne. D\'autres ont hésité. C\'est 10% du marché ou 50% ? Si c\'est 50%, toute notre stratégie est à revoir.' },
            { point: 'On apprend comment ils achètent', detail: 'Praticiens solo, propriétaires de cabinet, français vs. international — ils décident tous différemment. On n\'a pas de playbook. On l\'écrit en temps réel.' },
          ],
        },
        reds: {
          title: 'Les Vrais Risques',
          items: [
            { point: 'Revenu : zéro. Littéralement zéro.', detail: 'Plein de "intéressant !" et "je testerais !" — zéro euros en banque venant de clients. Si ça ne change pas dans 90 jours, y\'a un problème fondamental.' },
            { point: 'Pas de clinicien dans la pièce', detail: 'On prend des décisions produit sur des workflows cliniques sans personne du milieu dans l\'équipe. On valide par les démos, mais on pourrait construire les mauvaises choses sans même le savoir.' },
            { point: 'La réglementation est un labyrinthe qu\'on cartographie encore', detail: 'RGPD, HDS, données patients — on apprend en avançant. Une erreur de conformité à ce stade pourrait être existentielle. Pas "oups" existentiel. Vraiment existentiel.' },
            { point: 'Une fuite de données ou un problème légal touche tout le monde', detail: 'On manipule des données de santé sensibles. Si quelque chose tourne mal — une fuite, une plainte, une action réglementaire — ça ne touche pas que la boîte. Chaque personne de l\'équipe est directement ou indirectement impactée. C\'est le poids de construire dans la healthtech.' },
            { point: 'Des concurrents financés existent', detail: 'Doctolib, Quenza, SimplePractice — ils ont l\'argent, les équipes, les utilisateurs. On est en avance sur l\'IA + UX aujourd\'hui. Cette fenêtre ne restera pas ouverte éternellement.' },
            { point: 'Les thérapeutes n\'en veulent peut-être pas encore', detail: 'Beaucoup sont sincèrement contents avec leurs carnets et Google Drive. Vendre à des gens qui pensent ne pas avoir de problème, c\'est un sport particulier. On est peut-être trop tôt.' },
          ],
        },
        whyJoin: {
          title: 'Pourquoi Nous Rejoindre Maintenant — Malgré Tout Ça',
          items: [
            'Vous rejoignez un produit qui marche, pas un pitch deck. Les fondations sont là — ce qui manque c\'est l\'équipe pour en faire un business.',
            'Vous rejoignez avant le revenu = equity de fondateur, influence de fondateur, et zéro "on a toujours fait comme ça" à combattre.',
            'L\'outillage santé mentale est cassé et tout le monde le sait. Les vents porteurs sont structurels, pas du hype.',
            'Cette page existe parce qu\'on préfère vous effrayer avec de l\'honnêteté que vous impressionner avec du bullshit. Si un truc ici vous inquiète, tant mieux. Si un truc vous excite malgré tout — c\'est ça le signal.',
            'La partie la plus dure est faite. Prochaine étape : market fit, revenu, croissance. Votre impact se voit en mois, pas en années.',
          ],
        },
      },
    },
