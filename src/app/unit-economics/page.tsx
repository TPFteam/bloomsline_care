...
function getLTVCalc(t: TFunc): LTVComponent[] {
  return [
    { label: t('ARPU (monthly, modeled)', 'ARPU (mensuel, modélisé)'), formula: t('Blended average of tier mix', 'Moyenne pondérée des offres'), value: '~€25.50/mo', assumption: t('20% Essentiel (€19) + 70% Pro (€29) + 10% Cabinet (~€29/head). Tier mix is projected, not observed.', '20% Essentiel (19€) + 70% Pro (29€) + 10% Cabinet (~29€/tête). La répartition est projetée, non observée.') },
    { label: t('Gross margin (modeled)', 'Marge brute (modélisée)'), formula: t('(Revenue - Variable Cost) / Revenue', '(Revenu - Coût variable) / Revenu'), value: '~83%', assumption: t('Variable cost €4.25/practitioner/mo (AI €1.80 + infra €0.95 + support €1.50). Against blended ARPU of ~€25.50.', 'Coût variable 4,25€/praticien/mois (IA 1,80€ + infra 0,95€ + support 1,50€). Contre un ARPU pondéré de ~25,50€.') },
...
function getAssumptions(t: TFunc): Assumption[] {
  return [
    { assumption: t('Starting practitioners at raise close', 'Praticiens au bouclage de la levée'), value: '10', justification: t('15 beta testers today, 0 paying. Target: 10 paying by close (3-6 months of outreach). WTP not yet validated with transactions.', '15 bêta-testeurs aujourd\'hui, 0 payant. Objectif : 10 payants au bouclage (3-6 mois de prospection). La volonté de payer n\'est pas encore validée par des transactions.'), risk: t('High — WTP unproven', 'Élevé — volonté de payer non prouvée') },
    { assumption: t('Monthly price (blended ARPU)', 'Prix mensuel (ARPU pondéré)'), value: '~€25.50', justification: t('Weighted: 20% Essentiel (€19) + 70% Pro (€29) + 10% Cabinet (~€29/head). Charm price below €30. Less than 1 cancelled session (€60-80). Pricing not yet validated with paying customers.', 'Pondéré : 20% Essentiel (19€) + 70% Pro (29€) + 10% Cabinet (~29€/tête). Prix d\'appel sous 30€. Moins d\'une séance annulée (60-80€). La tarification n\'est pas encore validée avec des clients payants.'), risk: t('Medium — pricing unproven', 'Moyen — tarification non prouvée') },
    { assumption: t('Monthly churn rate', 'Taux d\'attrition mensuel'), value: '4%', justification: t('SaaS benchmark 2-10%. Care relationship may create lock-in (hypothesis). Practitioner switching cost assumed high. No churn data — zero paying customers.', 'Référence SaaS 2-10%. La relation de soin peut créer de la fidélité (hypothèse). Coût de changement du praticien supposé élevé. Aucune donnée d\'attrition — zéro client payant.'), risk: t('High — entirely modeled, no real data', 'Élevé — entièrement modélisé, aucune donnée réelle') },
    { assumption: 'CAC', value: '€50', justification: t('Modeled, not proven. Organic/content-driven. No paid ads. LinkedIn outreach + referrals. Below SaaS benchmark (€200-500).', 'Modélisé, non prouvé. Organique/contenu. Pas de publicité payante. Prospection LinkedIn + parrainages. Sous la référence SaaS (200-500€).'), risk: t('Medium — modeled, not observed', 'Moyen — modélisé, non observé') },
    { assumption: t('Gross margin', 'Marge brute'), value: '~83%', justification: t('Modeled. Variable cost €4.25/mo against ~€25.50 blended ARPU. AI on Claude Haiku ($1/$5 per MTok). SaaS best-in-class is 70-90%.', 'Modélisé. Coût variable 4,25€/mois contre ~25,50€ d\'ARPU pondéré. IA sur Claude Haiku (1$/5$ par MTok). Les meilleurs SaaS : 70-90%.'), risk: t('Low — Haiku pricing is stable and declining', 'Faible — les tarifs Haiku sont stables et en baisse') },
    { assumption: t('Members per practitioner', 'Membres par praticien'), value: '20-50', justification: t('Average caseload 15-25 clients per practitioner, rotating over time. Adoption rate when recommended by therapist is unproven. This network effect is the core hypothesis.', 'Charge de travail moyenne 15-25 clients par praticien, rotation dans le temps. Taux d\'adoption quand recommandé par le thérapeute non prouvé. Cet effet réseau est l\'hypothèse centrale.'), risk: t('High — network effect unproven', 'Élevé — effet réseau non prouvé') },
    ...
    { assumption: t('Starting cash', 'Trésorerie de départ'), value: '€450,000', justification: t('Mid-point of €400K-€500K pre-seed raise target. Provides ~18 months runway at current burn rate.', 'Point médian de l\'objectif de levée pré-seed 400K€-500K€. Offre ~18 mois de runway au rythme de burn actuel.'), risk: t('Low — aligned with raise expectations', 'Faible — aligné avec les attentes de levée') },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-6 sm:px-8 py-10 space-y-14">
        ...
        <motion.section {...fadeUp(0.2)}>
          <SectionTitle subtitle={t('Base case (modeled): ~€25.50 blended ARPU, 30% initial growth, 4% churn, €400-500K pre-seed raise', 'Cas de base (modélisé) : ~25,50€ d\'ARPU pondéré, croissance initiale 30%, 4% d\'attrition, levée pré-seed 400-500K€')}>
