...
const translations = {
  en: {
    ...
    market: {
      ...
      stats: [
        { value: '$380B', desc: 'Global mental health market by 2030' },
        { value: '700K+', desc: 'Therapists in Europe alone' },
        { value: '12%', desc: 'Annual market growth rate' },
      ],
      whyNow: 'Why Now?',
      reasons: [
        'Post-2020 mental health is destigmatized',
        'AI companions are socially accepted',
        'Practitioners need better outcome tools',
  ...
  fr: {
    ...
    market: {
      ...
      stats: [
        { value: '380 Mrd$', desc: 'Marché mondial de la santé mentale d\'ici 2030' },
        { value: '700K+', desc: 'Thérapeutes rien qu\'en Europe' },
        { value: '12%', desc: 'Taux de croissance annuel du marché' },
      ],
      whyNow: 'Pourquoi maintenant ?',
      reasons: [
        'Post-2020, la santé mentale est déstigmatisée',
        'Les compagnons IA sont socialement acceptés',
        'Les praticiens ont besoin de meilleurs outils de résultats',
