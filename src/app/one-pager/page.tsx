...
const translations = {
  en: {
    header: {
      tagline: 'The between-session care platform',
    ...
    market: {
      label: 'MARKET',
      tam: { label: 'TAM', value: '\u20ac12B' },
      sam: { label: 'SAM', value: '\u20ac2B' },
      som: { label: 'SOM', value: '\u20ac50M' },
      growth: '25% CAGR \u00b7 EU Digital Mental Health',
    },
    pillars: {
      label: 'WHY WE WIN',
      items: [
        { acronym: 'AI', name: 'Context Engine', desc: 'Learns from moments, gives practitioners pre-session briefs' },
        { acronym: 'SEO', name: 'Organic Distribution', desc: 'Practitioner profiles drive inbound, zero ad spend' },
        { acronym: 'B2B2C', name: 'Network Effect', desc: 'Each practitioner brings 20\u201350 members at zero CAC' },
        { acronym: 'UX', name: 'Retention by Design', desc: 'No streaks or guilt \u2014 narrative progress keeps users engaged' },
      ],
    },
    traction: {
      label: 'WHERE WE ARE',
      text: 'Pre-revenue \u00b7 MVP live \u00b7 15 beta testers \u00b7 119 discovery interviews \u00b7 Q1 2026',
    },
    ask: {
      label: 'THE ASK',
      amount: '\u20ac400K \u2013 \u20ac500K',
      runway: '18 months to prove PMF',
      funds: [
        { label: 'Product', percent: 40 },
        { label: 'Team', percent: 25 },
        { label: 'GTM', percent: 25 },
        { label: 'Ops', percent: 10 },
      ],
    },
    footer: {
      model: 'B2B SaaS \u00b7 \u20ac19\u201349/mo \u00b7 Members free',
      cta: 'Book a 20-min Call',
    },
  },
  fr: {
    header: {
      tagline: 'La plateforme de soin entre les s\u00e9ances',
    ...
    market: {
      label: 'MARCH\u00c9',
      tam: { label: 'TAM', value: '12 Mrd\u20ac' },
      sam: { label: 'SAM', value: '2 Mrd\u20ac' },
      som: { label: 'SOM', value: '50 M\u20ac' },
      growth: '25% TCAC \u00b7 Sant\u00e9 mentale num\u00e9rique UE',
    },
    pillars: {
      label: 'POURQUOI ON GAGNE',
      items: [
        { acronym: 'IA', name: 'Moteur Contextuel', desc: 'Apprend des moments, donne aux praticiens un brief pr\u00e9-s\u00e9ance' },
        { acronym: 'SEO', name: 'Distribution Organique', desc: 'Profils praticiens g\u00e9n\u00e8rent l\'inbound, z\u00e9ro budget pub' },
        { acronym: 'B2B2C', name: 'Effet R\u00e9seau', desc: 'Chaque praticien am\u00e8ne 20\u201350 membres \u00e0 CAC z\u00e9ro' },
        { acronym: 'UX', name: 'R\u00e9tention par Design', desc: 'Pas de s\u00e9ries ni culpabilit\u00e9 \u2014 le progr\u00e8s narratif engage' },
      ],
    },
    traction: {
      label: 'O\u00d9 NOUS EN SOMMES',
      text: 'Pr\u00e9-revenu \u00b7 MVP en ligne \u00b7 15 testeurs b\u00eata \u00b7 119 entretiens d\u00e9couverte \u00b7 T1 2026',
    },
    ask: {
      label: 'LA DEMANDE',
      amount: '400K\u20ac \u2013 500K\u20ac',
      runway: '18 mois pour prouver le PMF',
      funds: [
        { label: 'Produit', percent: 40 },
        { label: '\u00c9quipe', percent: 25 },
        { label: 'GTM', percent: 25 },
        { label: 'Ops', percent: 10 },
      ],
    },
    footer: {
      model: 'B2B SaaS \u00b7 19\u201349\u20ac/mois \u00b7 Membres gratuit',
      cta: 'R\u00e9server 20 min',
    },
  },
}
