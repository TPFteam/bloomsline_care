        ...
        <motion.section {...fadeUp(0.2)}>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              { key: 'sam', label: 'SAM', sublabel: t('EU Practice Software + Apps', 'Logiciels de cabinet + applications UE'), insight: t('Where we compete — the tools EU practitioners and members actually pay for today.', 'La ou nous sommes en concurrence — les outils que les praticiens et les membres en UE paient aujourd\'hui.'), cagr: '25%', stroke: '#A88AE1', gradId: 'samGrad', stopColor: '#A88AE1', color: 'text-violet-600', bg: 'border-violet-200', formatter: (v: number) => `€${v}B`, sources: [{ label: 'Verified Market Reports', url: 'https://www.verifiedmarketreports.com/product/mental-health-practice-management-software-market/' }] },
