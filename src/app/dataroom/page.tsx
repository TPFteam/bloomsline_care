...
function getPAGES(t: T): PageItem[] {
  return [
    ...
    {
      id: 'product-demo',
      label: t('Product Demo', 'Démo produit'),
      description: t('Visual walkthrough — dashboard, member app, Bloom AI, resource library', 'Visite guidée visuelle — tableau de bord, app membre, Bloom AI, bibliothèque de ressources'),
      href: '#',
      icon: Monitor,
      color: 'bg-gray-100 text-gray-400',
      borderColor: 'border-gray-200',
