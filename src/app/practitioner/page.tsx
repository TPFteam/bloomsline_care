...
function PractitionerNewContent() {
  ...
  const content = {
    hero: {
      ...
      headline: {
        en: 'Every person you sit with is different.',
        fr: 'Chaque personne que vous accompagnez est différente.',
      },
      subtitle: {
        en: 'Prepare faster, keep everything organized, track real progress, and share the right resources.',
        fr: 'Préparez plus vite, gardez tout organisé, suivez les vrais progrès et partagez les bonnes ressources.',
      },
      subtitleHighlight: {
        en: 'All from one simple place.',
        fr: 'Le tout depuis un seul endroit.',
      },
      cta: {
        en: 'Get Early Access',
        fr: 'Accès anticipé',
    ...
    dayWith: {
      headline: {
        en: 'How it fits into your day',
        fr: 'Comment ça s\'intègre à votre journée',
      },
      subtitle: {
        en: 'Same people. Same practice. Less friction.',
        fr: 'Les mêmes personnes. La même pratique. Moins de friction.',
      },
      moments: [
        {
          time: { en: 'Before a session', fr: 'Avant une séance' },
          pain: { en: 'Notes pile up, context gets lost', fr: 'Les notes s\'accumulent, le contexte se perd' },
          description: {
            en: 'Everything you need, already there. No digging.',
            fr: 'Tout ce qu\'il vous faut, déjà là. Sans chercher.',
          },
          icon: Clock,
        },
        {
          time: { en: 'During a session', fr: 'Pendant une séance' },
          pain: { en: 'Admin steals time from what matters', fr: 'L\'administratif vole du temps à l\'essentiel' },
          description: {
            en: 'Stay present. Notes flow. Nothing gets lost.',
            fr: 'Restez présent. Les notes coulent. Rien ne se perd.',
          },
          icon: Heart,
        },
        {
          time: { en: 'Between sessions', fr: 'Entre les séances' },
          pain: { en: 'The connection fades', fr: 'La connexion s\'estompe' },
          description: {
            en: 'They reflect, access resources, and feel supported on their own.',
            fr: 'Ils réfléchissent, accèdent aux ressources et se sentent soutenus seuls.',
          },
          icon: MessageSquare,
        },
        {
          time: { en: 'Over time', fr: 'Au fil du temps' },
          pain: { en: 'Progress lives in your head, not on screen', fr: 'Les progrès restent dans votre tête, pas à l\'écran' },
          description: {
            en: 'See real progress, not just snapshots.',
            fr: 'Voyez les vrais progrès, pas juste des instantanés.',
          },
          icon: Zap,
        },
      ],
    ...
    audience: {
      ...
      subtitle: {
        en: 'Less admin, more time with the people you care about.',
        fr: 'Moins d\'administratif, plus de temps avec ceux qui comptent.'
      },
      types: [
  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      <main>
        ...
        {/* A Day With Bloomsline — pain points + solutions woven together */}
        <section id="practitioner-content" className="py-20 bg-white">
        ...
        {/* Glimpse Section — Resources, Sessions, Overview */}
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <div className="text-center mb-12">
                <span className="inline-block px-4 py-2 bg-teal-500/10 text-teal-600 rounded-full text-sm font-medium mb-4">
                  FAQ
                </span>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  ...
                  className="px-8 py-4 bg-teal-600 text-white rounded-full font-medium inline-flex items-center gap-2 hover:bg-teal-700 transition-colors shadow-lg shadow-teal-600/30"
                >
                  {l(content.hero.cta)}
                  <ArrowRight className="w-4 h-4" />
                </button>
