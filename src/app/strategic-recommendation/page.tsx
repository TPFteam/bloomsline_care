...
export default function StrategicRecommendationPage() {
  ...
  const CURRENT_STATE = {
    strengths: [
      ...
      { label: t('Projected unit economics look strong — on paper', 'L\'économie unitaire projetée semble solide — sur le papier'), detail: t('Projected LTV/CAC 72.5x (vs. 3-5x median), projected 85% gross margin, estimated €50 CAC, 1.7-month payback. The hypothesized network effect (1 practitioner invites 20-50 members at zero CAC) could make acquisition economics structurally superior. These are ALL projections — nothing is measured. IF the assumptions hold.', 'LTV/CAC projeté 72,5x (vs. 3-5x médiane), marge brute projetée 85%, CAC estimé 50€, retour sur investissement 1,7 mois. L\'effet réseau hypothétique (1 praticien invite 20-50 membres à un CAC nul) pourrait rendre l\'économie d\'acquisition structurellement supérieure. Ce sont TOUTES des projections — rien n\'est mesuré. SI les hypothèses se confirment.'), rating: t('Projected', 'Projeté') },
    ...
    weaknesses: [
      { label: t('Zero revenue. Zero paying customers. Zero validated demand.', 'Zéro revenu. Zéro client payant. Zéro demande validée.'), detail: t('Every financial metric (LTV, CAC, churn, LTV/CAC) is modeled, not observed. 119 discovery interviews and 15 beta testers validate interest, but stated preference ≠ purchasing behavior. Woebot had 5+ RCTs and $123M funding and still failed commercially. The gap between "interesting" and "I will pay monthly" remains uncrossed.', 'Chaque métrique financière (LTV, CAC, churn, LTV/CAC) est modélisée, pas observée. 119 entretiens de découverte et 15 bêta-testeurs valident l\'intérêt, mais préférence déclarée ≠ comportement d\'achat. Woebot avait 5+ ECR et 123M$ de financement et a quand même échoué commercialement. L\'écart entre « intéressant » et « je paierai chaque mois » reste à franchir.'), severity: t('Critical', 'Critique') },
  ...
  const OPTIONS: StrategicOption[] = [
    {
      ...
      investment: t('€250-300K pre-seed raise', 'Levée pré-seed de 250-300K€'),
    ...
    },
    {
      ...
      subtitle: t('Prove France, then expand to 3 markets within pre-seed runway', 'Prouver la France, puis s\'étendre à 3 marchés dans le runway pré-seed'),
      ...
      description: t('Raise \u20ac400-500K pre-seed. Hire first engineer within 60 days (\u20ac2.5K/month). Founders at \u20ac2.5K/month each. Burn: \u20ac10-12K/month. France-first GTM with hard 90-day milestone (10 practitioners or pivot). Belgium/Switzerland expansion at M4-6. Begin German localization at M8. Active investor networking from M9. Target Series A by M18.', 'Lever 400-500K\u20ac en pr\u00e9-seed. Recruter le premier ing\u00e9nieur sous 60 jours (2,5K\u20ac/mois). Fondateurs \u00e0 2,5K\u20ac/mois chacun. Burn : 10-12K\u20ac/mois. GTM France d\'abord avec jalon ferme \u00e0 90 jours (10 praticiens ou pivot). Expansion Belgique/Suisse \u00e0 M4-6. D\u00e9but localisation allemande \u00e0 M8. Networking investisseurs actif d\u00e8s M9. Series A cibl\u00e9e \u00e0 M18.'),
      investment: t('€400-500K pre-seed raise', 'Levée pré-seed de 400-500K€'),
    ...
    },
    {
      ...
      investment: t('€500-750K pre-seed raise', 'Levée pré-seed de 500-750K€'),
  ...
  const INITIATIVES: Initiative[] = [
    {
      ...
      metric: t('10 practitioners paying €19-49/mo, <8% churn, NPS >30', '10 praticiens payant 19-49€/mois, <8% churn, NPS >30'),
      investment: t('€0 cash (100% founder time)', '0€ en cash (100% du temps des fondateurs)'),
      color: 'border-red-200 bg-red-50',
    },
    {
      rank: 2,
      title: t('Close pre-seed round within 60 days', 'Clôturer la levée pré-seed en 60 jours'),
      rationale: t('Fundraising is a full-time job that competes with sales. Every week spent fundraising is a week not spent acquiring practitioners. Target €400-500K. Minimum viable: €300K. Close fast, then redirect all energy to GTM.', 'La levée de fonds est un travail à plein temps qui concurrence les ventes. Chaque semaine passée à lever des fonds est une semaine non consacrée à l\'acquisition de praticiens. Cible : 400-500K€. Minimum viable : 300K€. Clôturer rapidement, puis rediriger toute l\'énergie vers le GTM.'),
    ...
    },
    {
      ...
      timeline: t('Post-close → 30 days', 'Post-clôture → 30 jours'),
  ...
  const RESOURCES: ResourceReq[] = [
    ...
    },
    {
      ...
      items: [
        { role: t('Pre-seed round', 'Tour pré-seed'), cost: '€400-500K', when: t('M0 (immediate)', 'M0 (immédiat)'), why: t('Runway for 18 months. Covers team, GTM, initial expansion, compliance.', 'Runway de 18 mois. Couvre l\'équipe, le GTM, l\'expansion initiale, la conformité.') },
  ...
  const DECISION_FRAMEWORK: DecisionCriteria[] = [
    ...
    },
    {
      ...
      weight: '15%',
      description: t('With 119 interviews and a live MVP, decisions should be grounded in observed behavior — not hypotheses. If no data exists, design the experiment first.', 'Avec 119 entretiens et un MVP en production, les décisions doivent s\'appuyer sur des comportements observés — pas des hypothèses. Si aucune donnée n\'existe, concevoir d\'abord l\'expérimentation.'),
        ...
        <motion.section {...fadeUp(0.03)}>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
            <p className="text-[11px] text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">{t('The opportunity is real and time-bound.', 'L\'opportunité est réelle et limitée dans le temps.')}</span> {t('Bloomsline operates in a $33B global digital mental health market growing at 18.6% CAGR, targeting a \u20ac166M European segment with no direct competitors today. The B2B2C architecture \u2014 where one practitioner sale could yield 20-50 free members (unproven hypothesis) \u2014 projects strong unit economics (72.5x LTV/CAC, 85% gross margin) IF assumptions hold. The B2C therapy model is struggling (BetterHelp -11%, Woebot shutdown), and capital is migrating to practitioner-first models (Talkspace B2B +42% YoY). The EU regulatory landscape (GDPR, AI Act, DiGA) favors European-native builders. We estimate a 12-18 month window before SimplePractice ($4B, Vista) or Doctolib (\u20ac6.4B) could converge into the space.', 'Bloomsline op\u00e8re dans un march\u00e9 mondial de la sant\u00e9 mentale num\u00e9rique de 33 milliards $, en croissance de 18,6% TCAC, ciblant un segment europ\u00e9en de 166M\u20ac sans concurrent direct aujourd\'hui. L\'architecture B2B2C \u2014 o\u00f9 une vente praticien pourrait g\u00e9n\u00e9rer 20-50 membres gratuits (hypoth\u00e8se non prouv\u00e9e) \u2014 projette une \u00e9conomie unitaire solide (72,5x LTV/CAC, marge brute 85%) SI les hypoth\u00e8ses se confirment. Le mod\u00e8le B2C de th\u00e9rapie est en difficult\u00e9 (BetterHelp -11%, fermeture Woebot), et les capitaux migrent vers les mod\u00e8les centr\u00e9s sur le praticien (Talkspace B2B +42% en glissement annuel). Le paysage r\u00e9glementaire europ\u00e9en (RGPD, AI Act, DiGA) favorise les acteurs europ\u00e9ens natifs. Nous estimons une fen\u00eatre de 12-18 mois avant que SimplePractice (4 milliards $, Vista) ou Doctolib (6,4 milliards \u20ac) ne convergent vers cet espace.')}
            </p>
            <p className="text-[11px] text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">{t('The product is built. Revenue is not.', 'Le produit est construit. Le revenu ne l\'est pas.')}</span> {t('The MVP is complete: 24+ API endpoints, 7 AI features (Claude Haiku/Sonnet), 3-language support, mobile app, real-time subscriptions. 119 discovery interviews and 15 beta testers validate the problem exists. But every financial metric — LTV, CAC, churn, LTV/CAC — is projected, not observed. Two founders cover every function. There are no paying customers, no clinical evidence, and no engineering team beyond the founding pair. The gap between a well-built product and a viable business remains the central strategic challenge.', 'Le MVP est complet et techniquement impressionnant : 24+ endpoints API, 7 fonctionnalités IA (Claude Haiku/Sonnet), support 3 langues, application mobile, abonnements en temps réel. 119 entretiens de découverte dans 7 pays valident le problème. Mais chaque métrique financière — LTV, CAC, churn, LTV/CAC — est projetée, non observée. Deux fondateurs couvrent toutes les fonctions. Il n\'y a aucun client payant, aucune preuve clinique, et aucune équipe technique au-delà du duo fondateur. L\'écart entre un produit bien construit et une entreprise viable reste le défi stratégique central.')}
            </p>
            <p className="text-[11px] text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">{t('Our recommendation: Option B — Validated Expansion.', 'Notre recommandation : Option B — Expansion validée.')}</span> {t('Raise \u20ac400-500K pre-seed. Set a non-negotiable 90-day milestone: 10 paying practitioners or pivot positioning. Hire one engineer immediately post-close to free founders for GTM. Expand to Belgium and Switzerland at M4-6 (zero localization cost) to prove multi-market viability. Begin German localization at M8. Target 120-150 practitioners across 3-4 markets by Month 12. This approach balances speed against capital preservation, creates a compelling Series A narrative, and maintains optionality to pivot if PMF is slower than modeled.', 'Lever 400-500K\u20ac en pré-seed. Fixer un jalon non négociable à 90 jours : 10 praticiens payants ou pivot du positionnement. Recruter un ingénieur immédiatement après la clôture pour libérer les fondateurs pour le GTM. S\'étendre à la Belgique et la Suisse à M4-6 (coût de localisation nul) pour prouver la viabilité multi-marchés. Commencer la localisation allemande à M8. Cibler 120-150 praticiens sur 3-4 marchés d\'ici le mois 12. Cette approche équilibre la vitesse et la préservation du capital, crée un narratif Series A convaincant et maintient l\'optionalité de pivoter si le PMF est plus lent que modélisé.')}
            </p>
          </div>
        </motion.section>
        ...
        <motion.section {...fadeUp(0.08)}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
            {[
              ...
              { label: t('Validation', 'Validation'), value: t('119 interviews', '119 entretiens'), sub: t('15 beta testers, 0 paying', '15 bêta-testeurs, 0 payant'), color: 'text-amber-600' },
              { label: t('Funding', 'Financement'), value: t('Seeking €400-500K', 'Recherche 400-500K€'), sub: t('Pre-seed', 'Pré-seed'), color: 'text-blue-600' },
            ].map((item, i) => (
          ...
          <div className="bg-emerald-50 border-2 border-emerald-200 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-emerald-600">{t('€400-500K pre-seed raise, 3-4 markets in 12 months, Series A by M18', 'Levée pré-seed 400-500K€, 3-4 marchés en 12 mois, Series A à M18')}</p>
              </div>
            </div>
          ...
          <div className="bg-gray-900 text-white rounded-xl p-6">
            ...
            <div className="bg-white/10 rounded-lg p-5 mb-5">
              ...
              <p className="text-sm text-white font-semibold leading-relaxed mb-3">
                {t('Bloomsline has built a product in a market with no direct EU competitors and favorable timing. The only question that matters is whether practitioners will pay for it.', 'Bloomsline a construit un produit dans un march\u00e9 sans concurrent direct europ\u00e9en et avec un timing favorable. La seule question qui compte est de savoir si les praticiens paieront pour l\u2019utiliser.')}
              </p>
              <p className="text-[10px] text-gray-400 leading-relaxed">
                {t('Every other question \u2014 expansion strategy, team scaling, regulatory compliance, competitive positioning \u2014 is downstream of this one. The projected 72.5x LTV/CAC ratio, the EU regulatory positioning, the hypothesized practitioner-to-member network effect, the $33B TAM \u2014 all of it is a hypothesis until the first 10 practitioners pay \u20ac19-49/month and continue paying the following month. Woebot raised $123M and had Stanford-published RCTs. They still failed. The product is not the hard part. Converting the first euro of recurring revenue is the hard part.', 'Toute autre question \u2014 strat\u00e9gie d\u2019expansion, passage \u00e0 l\u2019\u00e9chelle de l\u2019\u00e9quipe, conformit\u00e9 r\u00e9glementaire, positionnement concurrentiel \u2014 est en aval de celle-ci. Le ratio LTV/CAC projet\u00e9 de 72,5x, le positionnement r\u00e9glementaire europ\u00e9en, l\u2019effet r\u00e9seau hypoth\u00e9tique praticien-membres, le TAM de 33 milliards $ \u2014 tout cela reste une hypoth\u00e8se tant que les 10 premiers praticiens ne paient pas 19-49\u20ac/mois et ne continuent pas de payer le mois suivant. Woebot a lev\u00e9 123M$ et avait des ECR publi\u00e9es par Stanford. Ils ont quand m\u00eame \u00e9chou\u00e9. Le produit n\u2019est pas la partie difficile. Convertir le premier euro de revenu r\u00e9current est la partie difficile.')}
              </p>
            </div>
            ...
            <div className="bg-emerald-500/20 border border-emerald-500/30 rounded-lg p-5 mb-5">
              ...
              <p className="text-sm text-white font-semibold leading-relaxed mb-3">
                {t('Tomorrow morning, message 10 practitioners from your interview pool. Offer them the product at \u20ac19-49/month (Essentiel/Pro/Cabinet tiers). Not a free trial. Not a demo. A paid subscription. Today.', 'Demain matin, contactez 10 praticiens de votre panel d\u2019entretiens. Proposez-leur le produit \u00e0 19-49\u20ac/mois (paliers Essentiel/Pro/Cabinet). Pas un essai gratuit. Pas une d\u00e9mo. Un abonnement payant. Aujourd\u2019hui.')}
              </p>
              <p className="text-[10px] text-gray-300 leading-relaxed">
                {t('You have 119 interviews. At least 20-30 of those practitioners expressed strong interest. They have seen the product. They know the founders. The barrier to asking for money is psychological, not strategic. If 3 out of 10 say yes, you have product-market signal. If 0 out of 10 say yes, you have the most valuable data point in the company\'s history — and you got it before spending any investor capital.', 'Vous avez 119 entretiens. Au moins 20-30 de ces praticiens ont exprimé un fort intérêt. Ils ont vu le produit. Ils connaissent les fondateurs. La barrière pour demander de l\'argent est psychologique, pas stratégique. Si 3 sur 10 disent oui, vous avez un signal de product-market fit. Si 0 sur 10 disent oui, vous avez le point de données le plus précieux de l\'histoire de l\'entreprise — et vous l\'avez obtenu avant de dépenser du capital investisseur.')}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="bg-white/5 rounded-lg p-3 text-center">
                ...
                <p className="text-[9px] text-gray-500 mt-1">{t('Raise pre-seed with confidence. Execute Option B.', 'Lever le pr\u00e9-seed avec confiance. Ex\u00e9cuter l\'option B.')}</p>
              </div>
              <div className="bg-white/5 rounded-lg p-3 text-center">
